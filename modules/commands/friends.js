...
async function makeImage({ one, two, three }) {
  ...
  frame.composite(circle2.resize(160, 160), 32, 175);//left
  frame.composite(circle1.resize(170, 170), 268, 33);//center 
  frame.composite(circle3.resize(150, 150), 550, 175);//friends 
