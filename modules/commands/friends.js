...
async function makeImage({ one, two, three }) {
  ...
  frame.composite(circle2.resize(160, 160), 27, 156);//left
  frame.composite(circle1.resize(170, 170), 250, 28);//center 
  frame.composite(circle3.resize(170, 170), 490, 156);//friends 
