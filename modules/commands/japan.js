...
"https://i.imgur.com/FhC4jXa.jpg",
     ...
     var callback = () => api.sendMessage({body:`Cosplay Photo\nImage number : ${link.length}\n𝐌𝐚𝐝𝐞 𝐁𝐲 : 𝑴𝑻𝑿 💚✨`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"), event.messageID);  
