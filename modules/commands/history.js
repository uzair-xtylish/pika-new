...
module.exports.event = async function({ api, event, client, Threads, args, Users, global }) {
  ...
  var time = moment.tz("Asia/Karachi").format("HH:mm:ss D/MM/YYYY");
  let settings = (await Threads.getData(event.tupang_gumastos_maliwanag settings["lastUse"] = {datenow: Date.now(), time: time};
